...
def get_board(lines, diag=False):
    input_lines = []
...
count1 = sum(sum([1 if v > 1 else 0 for v in b]) for b in get_board(lines, diag=False))
print("Task 1:", count1)

count2 = sum(sum([1 if v > 1 else 0 for v in b]) for b in get_board(lines, diag=True))
print("Task 2:", count2)
